...
for partnum in range(1, total_parts+1):
    ...
    eng_novel_filepath = f"/work/tc046/tc046/s2252632/vecalign/{bookname}_src/ENG_modified_sentence_combos/ENG_{bookname}_{partnum}.en"

    # FILEPATH: Tibetan overlap file (combinations)
    
    tib_data_path = f"/work/tc046/tc046/s2252632/vecalign/{bookname}_src/sentence_combos/BO_{bookname}_{partnum}.bo"
    ...
    # linenum = 0
    # modified_tiboverlap_out = f"/work/tc046/tc046/s2252632/vecalign/{bookname}_src/BO_modified_sentence_combos_perline/part_{partnum}/BO_{bookname}_{partnum}_line{linenum}.bo"

    # ALTER DICT PATHS during full run to use full dicts, not minidicts. Dicts are book and book-part specific.
    valby_dict_path = f"/work/tc046/tc046/s2252632/dict_transl/{bookname}_dicts/tibfiltered/jimvalby_dict_{bookname}_{partnum}.pickle"
    hopkins_dict_path = f"/work/tc046/tc046/s2252632/dict_transl/{bookname}_dicts/tibfiltered/hopkins_dict_{bookname}_{partnum}.pickle"
    ives_dict_path = f"/work/tc046/tc046/s2252632/dict_transl/{bookname}_dicts/tibfiltered/ives_dict_{bookname}_{partnum}.pickle"
