...
for filenum in range(1, total_parts+1):
    ...
    eng_data_path = f"/work/tc046/tc046/s2252632/vecalign/{bookname}_src/ENG_sentences/ENG_{bookname}_{filenum}"
    ...
    valby_dict_outpath = f"/work/tc046/tc046/s2252632/dict_transl/{bookname}_dicts/jimvalby_dict_{bookname}_{filenum}.pickle"
    hopkins_dict_outpath = f"/work/tc046/tc046/s2252632/dict_transl/{bookname}_dicts/hopkins_dict_{bookname}_{filenum}.pickle"
    ives_dict_outpath = f"/work/tc046/tc046/s2252632/dict_transl/{bookname}_dicts/ives_dict_{bookname}_{filenum}.pickle"
