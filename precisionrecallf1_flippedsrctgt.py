...
# specify whether bleualigned or vecaligned to specify how file should be parsed - "vec" or "bleu"
bleuorvec = "vec"

# automatic alignment file path
# auto_alignmentpath = "/work/tc046/tc046/s2252632/txt_to_continuous/.cache/Bleualign/bleualignment_grumpy.txt"

# auto_alignmentpath = "/work/tc046/tc046/s2252632/vecalign/vecaligntest_src/alignment_files/aligned_01_raw.txt" # VECALIGN Many:many possibility
# auto_alignmentpath = "/work/tc046/tc046/s2252632/vecalign/vecaligntest_src/manytoone_aligns/aligned_01_raw.txt" # Only allows 1:many or many:many possibilities --> only 1 on Eng side.
auto_alignmentpath = "/work/tc046/tc046/s2252632/vecalign/vecaligntest_src/method2_finalalignment/method2_finalalignment_indices"

# reference alignment file path - alignments in format per line: 
# 318,319,320 - 217,218
ref_alignmentpath = "/work/tc046/tc046/s2252632/dict_transl/latse7test_alignmentfile_modifiedindices.txt" 
        ...
        for line in al_file:
            if line.startswith("alignment:"):
                ...
                alignment = (source_sentences,  # No need to convert to tuple here, it's already handled
                         tuple(map(int, target_part.split(', '))),  # Convert to tuple
                         (1,))
...
def parse_vecaligned(auto_filepath):
    ...
    with open(auto_filepath, 'r') as al_file:
        for line in al_file:
            ...
            target_str, source_str, _ = line.split(':')
