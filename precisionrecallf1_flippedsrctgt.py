...
# auto_alignmentpath = #ADD: e.g. f"./vecalign/vecaligntest_src/manytoone_aligns/aligned_01_raw.txt" # Only allows 1:many or many:many possibilities --> only 1 on Eng side.
auto_alignmentpath = #ADD: e.g. f"./vecalign/vecaligntest_src/method2_finalalignment/method2_finalalignment_indices"
