...
indices_outfile = #ADD: e.g. f"./vecalign/{book}_src/method2_finalalignment/method2_finalalignment_indices"
...
for i in range(0, total_lines + 1):
    ...
    engline_alignment_file = read_file(#ADD: e.g. f"./vecalign/{book}_src/method2_alignmentfiles/aligned_01_line{num}_raw.txt")
