...
alignedtext_outfile_eng = f"/work/tc046/tc046/s2252632/vecalign/{book}_src/method2_finalalignment/ENG_method2_finalalignment_{book}"

alignedtext_outfile_bo = f"/work/tc046/tc046/s2252632/vecalign/{book}_src/method2_finalalignment/BO_method2_finalalignment_{book}"
...
for i in range(0, total_lines + 1):
    ...
    eng_alignment_text = read_file(f"/work/tc046/tc046/s2252632/vecalign/{book}_src/method2_alignedfiles/ENG_{book}_al_01_line{num}.txt")
    bo_alignment_text = read_file(f"/work/tc046/tc046/s2252632/vecalign/{book}_src/method2_alignedfiles/BO_{book}_al_01_line{num}.txt")
    
    # overlap file to check num eliminations in
    bo_overlap_file = f"/work/tc046/tc046/s2252632/vecalign/{book}_src/BO_modified_sentence_combos_perline/part_01/BO_{book}_01_line{num}.bo"
    
    # OG vecalign many-to-1 alignment TEXT
    og_bo_alignment = read_file(f"/work/tc046/tc046/s2252632/vecalign/{book}_src/manytoone_aligned/BO_{book}_al_01.txt")
    og_eng_alignment = read_file(f"/work/tc046/tc046/s2252632/vecalign/{book}_src/manytoone_aligned/ENG_{book}_al_01.txt")
    
    # OG vecalign many-to-1 alignment INDICES
    og_alignment_inds = read_file(f"/work/tc046/tc046/s2252632/vecalign/{book}_src/manytoone_aligns/aligned_01_raw.txt")
